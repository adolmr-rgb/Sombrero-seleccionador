...
Descripción:
Aplicación web interactiva inspirada en el Sombrero seleccionador de Harry Potter, que combina mi pasión por el mundo mágico con los conocimientos adquiridos durante el ciclo de grado superior en Desarrollo de Aplicaciones Web (DAW). 
El proyecto busca integrar creatividad y técnica mediante una experiencia lúdica, funcional y formativa.
...
Importa la base de datos desde la carpeta /sql en phpMyAdmin.
